...
function boot(){if(!document.getElementById('ddhv2-finder'))return;css();script('ddhv21-data','ddhifi-brand-data.js',function(){script('ddhv21-core','ddhifi-v21-core.js',function(){script('ddhv21-patches','ddhifi-v21-patches.js',function(){script('ddhv21-flows','ddhifi-v21-flows.js',function(){script('ddhv21-results','ddhifi-v21-results.js',function(){script('ddhv21-start','ddhifi-v21-start.js');});});});});});}
